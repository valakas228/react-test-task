            ...
            <div className="content-main-block">
              <div className="content-main-block-container1">
                ...
                <div>
                  <ul>
                    <li>
                      <span className="checkmark">&#10004;</span>№100000 По
                      качеству обучения по версии Smart Ranking
                    </li>
                    <li>
                      <span className="checkmark">&#10004;</span>90 различных
                      курсов
                    </li>
                    <li>
              ...
              <div className="section">
                <div className="description-wrapper">
                  <div className="description">
                    <ul>
                      <li>
                        <span className="checkmark">&#10004;</span>Курсы под
                        любые цели
                      </li>
                      <li>
                      ...
                      <li>
                        <span className="checkmark">&#10004;</span>Сотрудничаем
